        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Jangan melebihi bobot yang telah ditentukan!</h6>
                    <form class="forms-sample" action="{{ route('rekomendasi.desa') }}" id="form-hasil" method="POST">
                        @csrf
                        @for ($i = 0; $i < count($kriteria); $i++)
                        <div class="form-group">
                            <label>{{ $kriteria[$i]->nama }} ( {{ $kriteria[$i]->bobot }} )</label>
